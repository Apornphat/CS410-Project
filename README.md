...
เปิด **Terminal**(ด้านล่าง) แล้วพิมพ์:
** javac Main.java && java Main **

### ขั้นที่ 3 — เปิดหน้าจอ Desktop
1. คลิกแถบ **PORTS** ด้านล่าง
2. จะเห็น Port **6080** (websockify)
3. คลิก **Open in Browser** (เอาเมาส์ไปค้างที่ลิงก์จะขึ้นไอคอนลูกโลก แล้วกด)
4.หน้าแท็บใหม่เด้งขึ้นมา 
5.คลิกปุ่ม **Connect** (ไม่ต้องใส่รหัสผ่าน)
